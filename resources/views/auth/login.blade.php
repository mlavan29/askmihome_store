            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" name="login" id="login-box" action="#">
                    ...
                    <div class="form-group ">
                       ...
                       <div class="error mt-3" id="email_validation"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="error mt-3" id="password_validation"></div>
                        @error('password')
                        <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
        ...
        firebase.auth().signInWithEmailAndPassword(email, password).then(function (result) {
            ...
            database.collection("users").where("email", "==", userEmail).get().then(async function (snapshots) {
                ...
                if (userData.active == true) {
                    ...
                    $("#password_required").css('color', 'red').html("<p>{{trans('lang.waiting_for_approval')}}</p>");
                    return false;
                }
            })
            ...
            {   
                case "auth/invalid-email":
                         ...
                         $("#email_validation").html(error.message);
                         break;
                case "auth/wrong-password":
                    $("#email_validation").html("");
                    $("#password_validation").html(error.message);
                    break;
                default:
                    $("#password_validation").html("");
