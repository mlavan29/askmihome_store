    ...
    $(document).ready(function () {
      ...
      $(".save_coupon_btn").click(function () {
        ...
        if (code == '') {
          ...
          database.collection('coupons').doc(id).set({ 'code': code, 'description': description, 'discount': discount, 'expiresAt': expiresAt, 'isEnabled': isEnabled, 'id': id, 'discountType': discountType, 'image': photo, 'resturant_id': vandorId,'isPublic':isPublic }).then(function (result) {
