...
<div class="page-wrapper">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="{{route('stores.orders',$_GET['eid'])}}">{{trans('lang.order_plural')}}</a></li>
                <?php }else{ ?>
    ...
    ref.get().then(async function(snapshots) {
     ...
     if(order.address.hasOwnProperty('address') && order.address.address != null){
      billingAddressstring = billingAddressstring + order.address.address;
      }

      if (order.address.hasOwnProperty('locality') && order.address.locality != null) {
